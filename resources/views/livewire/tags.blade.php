<div class="container mx-auto flex items-center flex-wrap">
    @if($tags->count())
        @foreach($tags as $tag)
            <a href="#" class="lg:w-1/3 w-full p-6 text-white hover:shadow-xl shadow-slate-900 hover:scale-105 transition hover:rounded" style="background-color: {{ $tag->color }};">
